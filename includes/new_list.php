      ...
      <table>
         <tr>
            <td width="250px">
               ...
               <p class="description">Give Your List a Name. Tech, Cars, Music ect.</p>
            </td>
            <td>
         ...
         <tr>
            <td>
               ...
               <p class="description">Give Your list a description. Don't worry, your subscribers won't see this</p>
            </td>
            <td>
