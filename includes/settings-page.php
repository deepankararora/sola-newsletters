         ...
         <table width='100%'>
            <tr>
                  ...
                  <label>Sending Address</label>
                                         <p class="description" style='padding:10px;'>Enter a valid e-mail address here. eg. newsletter@mydomain.com</p>
               </td>
            ...
            <tr>
               <td>
                  <label>Name</label>
                                         <p class="description" style='padding:10px;'>Having a name is so much better than someone@unknown.com</p>
               </td>
               <td>
            ...
            <tr>
               <td>
                  ...
                  <p class='description' style='padding:10px;'>Your subscribers may want to talk to you, so let them.</p>
               </td>
               <td>
            ...
            <tr>
               <td>
                  <label>Reply to Name</label>
                                         <p class="description" style='padding:10px;'>Give people a name to reply to</p>
               </td>
               <td>
         ...
         <table width='100%'>
             <tr>
                   ...
                   <label>Email Notifications</label>
                                          <p class="description" style='padding:10px;'>The email address you would like Sola Newsletter plugin to keep in contact with you.</p>
                </td>
                <td>
             ...
             <tr>
                <td>
                   <label>Notifications</label>
                                          <p class="description" style='padding:10px;'>What would you like to be notified about?</p>
                </td>
                <td>
                   <input type="radio" name="sola_nl_notifications" value="1" <?php if ($notification == 1) echo "checked=checked"; ?>/> 
                   <label>On</label>
                   <p class='description'>You will receive notifications about all things important dealing with your campaigns and such</p>
                   <input type="radio" name="sola_nl_notifications" value="0" <?php if ($notification == 0) echo "checked=checked"; ?>/> 
                   <label>Off</label>
                   <p class='description'>Simple. You won't get any notifications. We don't recommend this</p>
                </td>
             </tr>
<?php /*             <tr>
                <td>
                   <label>Signature</label>
                      ...
                      Just like any other mail, you can add a signature under the footer to look pro. This also helps avoid those dreaded spam filters. 
                   </p>
                </td>
                <td>
                   <textarea style="height: 100px;" class='sola-input' name="sola_nl_sig"><?php echo stripslashes(get_option("sola_nl_sig")); ?></textarea>
                </td>
             </tr>
             <tr> */ ?>
                <td>
                   <label>Un-subscribe Text</label>
                   <p class='description' style='padding:10px;'>People sign up and then some un-subscribe. Don't worry about them, they were never true believers!</p>
                </td>
                <td>
                    <input type="text" required class='sola-input' name="sola_nl_unsubscribe" value="<?php echo get_option("sola_nl_unsubscribe"); ?>"/>
                </td>
             </tr>
          </table>
               ...
               <tr>
                <td width="40%" style='min-width:350px;'>
                   ...
                   <td>
                       ...
                       <br /><input type="checkbox" id='sola_nl_to_mail_test_debug' class='sola-input' name="sola_nl_to_mail_test_debug" placeholder='youremail@email.com' /> <?php _e("Show me the output (debugging purposes)","sola"); ?>
                   </td>
               </tr>
            </table>
      </div>
      <div id="tabs-3">
          ...
          <table>
              <tr>
                  ...
                  <td><input class="sola-input" type="text" name="sola_nl_sign_up_title" value="<?php echo get_option("sola_nl_sign_up_title"); ?>"/></td>
              </tr>
              <tr>
                  <td>
                      <label><?php _e("Button","sola") ?>:</label>
                                             <p class="description" style='padding:10px;'>Set the text of sign up button</p>
                  </td>
                  <td>
              ...
              <tr>
                  ...
                  <td>
                      <?php $sign_up_list = get_option("sola_nl_sign_up_lists");
                      if($sign_up_list){
      ...
      <div id="tabs-4">
          ...
          <table>
              ...
              <tr>
                  ...
                  <td><input name="social_links[<?php echo $social_name ?>]" type="text" value="<?php echo $social_link?>" /></td>
              </tr>
                <?php } ?>
          </table>
      </div>
        ...
        <div id="tabs-6">
            ...
            <p><strong><em>wget -O /dev/null http://yoursite.com/wp-cron.php?doing_wp_cron</em></strong></p>
            <p><br /><br /><?php _e("If you require technical support with setting up your cron job,","sola"); ?> <a target='_BLANK' href="http://solaplugins.com/technical-support/cron-job" title="Let Sola Plugins set up your cron job"><?php _e("we can assist you for a charge of $10","sola"); ?></a></p>
